...
import com.flyaway.database.AirLine;
...
public class AirLineList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
   		...
   		String new_airline= request.getParameter("new_airline");
		...
		{	
			...
			AirLine airline = new AirLine(new_airline);
			...
			out.println("<html>\n"
					...
					+ "<h1>A new Airline is added to the system!</h1>"	
