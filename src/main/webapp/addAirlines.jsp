...
<ul>
  ...
  <li><a href="Index.jsp">Logout</a></li>
	...
	<div align="center" class="container">
		<h2>Add Airline:</h2>
		<form action="AirLineList" method="POST">
			<label> Add New Airline : </label> 
			<input type="text" name="new_airline">
				&nbsp; &nbsp; &nbsp; &nbsp;
...
try {
	...
	ResultSet result = statement.executeQuery("SELECT * FROM airlines");
	
%>

<h1>List of AirLine</h1>
<table id="customers">
  <tr>
    <th>Airline ID</th>
    <th>Airline Name</th>
  ...
  <%
while(result.next()) {
	String airlines_ID = result.getString("airlines_ID");
